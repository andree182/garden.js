...
const tri = new THREE.CylinderGeometry(1, 1, 1, 3)
  ...
  return (
    <mesh receiveShadow castShadow {...props}>
      <Geometry ref={csg} computeVertexNormals>
        <Base name="base" geometry={box} scale={[3.5, 3, 5]} />
        <Subtraction name="cavity" geometry={box} scale={[2.7, 2.7, 4.7]} />
        <Addition name="roof" geometry={tri} scale={[2.5, 5.5, 1.425]} rotation={[-Math.PI / 2, 0, 0]} position={[0, 2.2, 0]} />
        ...
        <PivotControls activeAxes={[false, true, true]} rotation={[0, Math.PI / 2, 0]} scale={1} anchor={[0, 0, 0.4]} onDrag={(l) => (console.log(l, "XYZ"), csg.current.update())}>
          <Window position={[0, 0.25, 2.5]} scale={1.25} />
        </PivotControls>
